...
namespace stickynotes.Controllers
{
    public class StickiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Notetitle,Notetext,Order,NoteDate")] Sticky sticky)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Notetitle,Notetext,Order,NoteDate")] Sticky sticky)
        {
            if (id != sticky.Id)
            {
                return NotFound();
